...
namespace HotCoffee.AgoraChat.iOS
{
	...
	[BaseType (typeof(NSObject))]
	interface AgoraChatCursorResult
	{
		...
		AgoraChatCursorResult CursorResultWithList ([NullAllowed] NSObject[] aList, [NullAllowed] string aCusror);
	}
	...
	[BaseType (typeof(NSObject))]
	interface AgoraChatConversation
	{
	...
	[BaseType (typeof(NSObject))]
	interface AgoraChatMessageReaction
	{
	...
	[BaseType (typeof(NSObject))]
	interface AgoraChatTranslateLanguage
	{
...
*/[Protocol]
	...
	interface AgoraChatroomManagerDelegate
	{
		...
		[Export ("chatroomWhiteListDidUpdate:addedWhiteListMembers:")]
		void ChatroomWhiteListDidUpdate (AgoraChatroom aChatroom, string[] aMembers);
		...
		[Export ("chatroomWhiteListDidUpdate:removedWhiteListMembers:")]
		void ChatroomWhiteListDidUpdate (AgoraChatroom aChatroom, string[] aMembers);
		...
		void ChatroomAdminListDidUpdate (AgoraChatroom aChatroom, string aAdmin);
	...
	interface AgoraChatPageResult
	{
		...
		AgoraChatPageResult PageResultWithList ([NullAllowed] NSObject[] aList, nint aCount);
	}
...
*/[Protocol]
	...
	interface AgoraChatGroupManagerDelegate
	{
		...
		[Export ("groupWhiteListDidUpdate:addedWhiteListMembers:")]
		void GroupWhiteListDidUpdate (AgoraChatGroup aGroup, string[] aMembers);
		...
		[Export ("groupWhiteListDidUpdate:removedWhiteListMembers:")]
		void GroupWhiteListDidUpdate (AgoraChatGroup aGroup, string[] aMembers);
		...
		void GroupAdminListDidUpdate (AgoraChatGroup aGroup, string aAdmin);
	...
	[BaseType (typeof(NSObject))]
	interface AgoraChatGroupSharedFile
	{
...
*/[Protocol]
	...
	[BaseType (typeof(NSObject))]
	interface AgoraChatDeviceConfig
	{
	...
	interface AgoraChatClient
	{
		...
		[return: NullAllowed]
		AgoraChatError LoginWithUsername (string aUsername, string aToken);
		...
		void LoginWithUsername (string aUsername, string aToken, [NullAllowed] Action<NSString, AgoraChatError> aCompletionBlock);
		...
		[return: NullAllowed]
		AgoraChatError LoginWithUsername (string aUsername, string aAgoraToken);
		...
		void LoginWithUsername (string aUsername, string aAgoraToken, [NullAllowed] Action<NSString, AgoraChatError> aCompletionBlock);
